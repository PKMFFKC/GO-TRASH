...
class CoinPagePulsa extends StatefulWidget {
  const CoinPagePulsa({Key? key}) : super (key: key);

  @override
  _CoinPagePulsaState createState() => _CoinPagePulsaState();
}

class _CoinPagePulsaState extends State<CoinPagePulsa> {
  @override
