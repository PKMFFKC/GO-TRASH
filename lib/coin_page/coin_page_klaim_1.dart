...
class KlaimSukses extends StatefulWidget {
  const KlaimSukses({Key? key}) : super (key: key);

  @override
  _KlaimSuksesState createState() => _KlaimSuksesState();
}

class _KlaimSuksesState extends State<KlaimSukses> {
  @override
